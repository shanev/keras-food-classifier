...
model = load_model('models/VegeModelFinetuned.h5')
...
img = load_img('data/train/carrots/carrot5.jpg', False, target_size=(img_width, img_height))
x = img_to_array(img)
x = x / 255
...
img = load_img('data/train/kale/kale2a.jpg', False, target_size=(img_width, img_height))
x = img_to_array(img)
x = x / 255
x = x.reshape((1,) + x.shape)
pred = model.predict(x)
